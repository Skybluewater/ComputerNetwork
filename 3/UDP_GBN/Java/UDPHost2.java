...
public class UDPHost2 implements Runnable {
	...
	private static int recePort = 8888;
	...
	public void Send() throws Exception {
		...
		while (nbuffered != 0) {
			if (waitForResend == true && receiveFirstInfo == true) {
				continue;
			}
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			is = new FileInputStream(new File("D:\\desktop\\sendText2.txt"));
			os = new FileOutputStream(new File("D:\\desktop\\receiveText1.txt"));
